function prediction = KNNTestingFullImage(testImage, modelNN, k)
...
for index=1:k
    ...
    nearestNeighbours(index,2)=EuclideanDistance(testImage, modelNN.neighbours(index,:));
...
for index=k+1:numNeighbours
    ...
    currentDistance=EuclideanDistance(testImage, modelNN.neighbours(index,:));
